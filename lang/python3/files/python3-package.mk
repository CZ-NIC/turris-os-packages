...
PYTHON3_TARGET_STAGING_DIR:=$(STAGING_DIR)/lib/python$(PYTHON3_VERSION)/site-packages
PYTHON3_TARGET_ROOT_TURRIS_STAGING_DIR:=$(STAGING_DIR)/root-mvebu/usr/lib/python$(PYTHON3_VERSION)/site-packages
PYTHON3_TARGET_ROOT_OMNIA_STAGING_DIR:=$(STAGING_DIR)/root-mpc85xx/usr/lib/python$(PYTHON3_VERSION)/site-packages

PYTHON3PATH:=$(PYTHON3_LIB_DIR):$(STAGING_DIR)/$(PYTHON3_PKG_DIR):$(PKG_INSTALL_DIR)/$(PYTHON3_PKG_DIR):$(PYTHON3_TARGET_STAGING_DIR):$(PYTHON3_TARGET_ROOT_TURRIS_STAGING_DIR):$(PYTHON3_TARGET_ROOT_OMNIA_STAGING_DIR)
